...
app = Flask(__name__, static_url_path='', static_folder='C:\\Users\\Mohammed Askan\\Desktop\\Peeps\\static')
...
def create_radar_chart(df):
    ...
    categories = list(numeric_columns.columns)
    values = numeric_columns.iloc[0].values
    fig, ax = plt.subplots(figsize=(9.4, 4.1), subplot_kw=dict(polar=True))
